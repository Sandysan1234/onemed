            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="my-4">Tambah Alat Ukur</h1>
                            ...
                            <form method="post">
                                <div class="row border ">
                                    <div class="col-md-4 my-3">
                                        ...
                                        <input type="text" class="form-control" name="Nama_Alat_Ukur" id="Nama_Alat_Ukur" required>
                                    </div>
                                    <div class="col-md-4 my-3">
                                    ...
                                    <div class="col-md-4 my-3">
                                        ...
                                        <input type="text" class="form-control" name="Poin_Kalibrasi" id="Poin_Kalibrasi" required>
                                    </div>
                                    <div class="col-md-4 my-3">
                                        <label for="hasil pengukuruan" class="form-label">Hasil Pengukuruan</label>
                                        <input type="text" class="form-control" name="Hasil_Pengukuran" id="Hasil_Pengukuran" required>
                                    </div>
                                    <div class="col-md-4 my-3">
                                        <label for="koreksi" class="form-label">Koreksi</label>
                                        <input type="text" class="form-control" name="koreksi" id="koreksi" required>
                                    </div>
                                    <div class="col-md-4 my-3">
                                        <label for="u95" class="form-label">U95</label>
                                        <input type="text" class="form-control" name="u95" id="u95" required>
                                    </div>
                                    <div class="col-md-4 my-3">
                                        <label for="koreksi-u95" class="form-label">Koreksi & U95 yang diijinkan</label>
                                        <input type="text" class="form-control" name="Koreksi_U95_yang_diijinkan" id="Koreksi_U95_yang_diijinkan" required>
                                    </div>
                                    <div class="col-md-4 my-3">
